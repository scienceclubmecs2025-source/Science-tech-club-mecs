...
import { FileText, Users, Calendar, MessageSquare, Settings, Award, Bell } from 'lucide-react'
                ...
                {pendingApprovals.map((request) => (
                  <div key={request.id} className="bg-gray-800 rounded-xl p-4 border border-gray-700">
                    ...
                    <button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 py-2 rounded-lg text-sm font-medium"
                    >
                      Review
                    </button>
                  </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <p className="text-sm text-blue-200">View and manage members</p>
              </button>
              ...
              >
                ...
                <p className="text-sm text-purple-200">Manage events</p>
              </button>
              ...
              >
                ...
                <p className="text-sm text-yellow-200">Handle requests</p>
              </button>
              ...
              >
                ...
                <p className="text-sm text-gray-200">Club settings</p>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 text-sm">View and manage projects</p>
            </button>
            ...
            >
              ...
              <p className="text-gray-400 text-sm">Track assignments</p>
            </button>
            ...
            >
              ...
              <p className="text-gray-400 text-sm">Team chat</p>
            </button>
          </div>
        </div>
      </div>
