...
import { Shield, Users, Calendar, MessageSquare, Eye } from 'lucide-react'
import api from '../services/api'

export default function ViceChairDashboard() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold">Vice Chair Dashboard</h1>
          ...
          <div className="bg-blue-900/30 border border-blue-700 rounded-xl p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-200">
                You have view access to all club activities. Contact Chair or Secretary for edit permissions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              ...
              className="bg-gray-800 hover:bg-gray-750 p-6 rounded-xl text-left border border-gray-700"
            >
